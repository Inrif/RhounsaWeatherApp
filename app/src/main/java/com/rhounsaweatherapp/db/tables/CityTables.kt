package com.rhounsaweatherapp.db.tables

import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.ForeignKey
import androidx.room.PrimaryKey
import com.rhounsaweatherapp.model.cities.CitySaved
import com.rhounsaweatherapp.model.cities.CitySearchResult
...
fun List<DbSavedCityName>.asDomainModel(): List<CitySaved> {
    return map { c ->
        CitySaved(
            c.id,
