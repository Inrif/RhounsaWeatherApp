...
fun Rain(rain: Double) {
    Row(
        ...
        Image(
            painter = painterResource(drawable.rain_drop),
            contentDescription = stringResource(string.rain),
            modifier = Modifier.padding(end = 8.dp)
        )
        Text(text = stringResource(string.millimeters, "%.1f".format(rain)))
    }
}
...
fun Snow(snow: Double) {
    Row(
        ...
        Image(
            painter = painterResource(drawable.snow_flake),
            contentDescription = stringResource(string.snow),
            modifier = Modifier.padding(end = 8.dp)
        )
        Text(text = stringResource(string.millimeters, "%.1f".format(snow)))
    }
}
